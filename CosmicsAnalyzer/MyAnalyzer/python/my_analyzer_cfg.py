...
# global tag: https://twiki.cern.ch/twiki/bin/view/CMSPublic/SWGuideFrontierConditions#Analysis_recipes
...
process.source = cms.Source("PoolSource",
            ...
            'file:/eos/user/d/dazhang/cms/ZMu/28e81690-aa38-4934-9ad6-05b2797148a1.root'
                )
                            )
...
process.muonAnalyzer = cms.EDAnalyzer("MyAnalyzer",
         muonCollection = cms.InputTag("muons")
        #  cosmicMuonCollection = cms.InputTag("standAloneMuons")
                                        )
...
process.TFileService = cms.Service("TFileService",
    fileName = cms.string(
        # "/afs/cern.ch/user/d/dazhang/private/cms/CMSSW_13_0_10/src/CosmicsAnalyzer/MyAnalyzer/test/CosmicSP_lhcSTAMuon_ntuple.root"
        "/afs/cern.ch/user/d/dazhang/private/cms/CMSSW_13_0_10/src/CosmicsAnalyzer/MyAnalyzer/test/ZMu_muons_ntuple.root"
        )
                                    )
...
# process.p = cms.Path(process.lhcSTAMuonAnalyzer)